...
const Login = () => {
    ...
    },[seekerState?.isAuthenticated, geekSliceState?.isAuthenticated, router, redirectTo])
    

    useEffect(() => {
        if(seekerState?.isLoginOTP && formik.values.phone !== '' && formik.isValid){
            setTimeout(() => {
              const otpParams = new URLSearchParams({ phone: formik.values.phone, context: 'login' })
            if (redirectTo !== '/') otpParams.set('redirect', redirectTo)
            router.push(`/verify-otp?${otpParams.toString()}`);
            },3000)
        }
  ...
  return (
    <section className='w-full flex flex-col justify-center items-center'>
                ...
                <div className='w-full breadcrumb-bg  relative flex justify-center items-center py-10  text-center bg-teal-600'>
                    <div className='xl:max-w-6xl w-full h-full lg:max-w-5xl md:max-w-3xl sm:max-w-xl mx-auto'>
                        ...
                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                         stroke="teal"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                         <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                         <g id="SVGRepo_iconCarrier"> 
                          <path d="M22 22L2 22" stroke="teal" strokeWidth="1.5" strokeLinecap="round"></path> 
                          <path d="M2 11L10.1259 4.49931C11.2216 3.62279 12.7784 3.62279 13.8741 4.49931L22 11" stroke="teal" strokeWidth="1.5" strokeLinecap="round"></path> 
                          <path d="M4 22V9.5" stroke="teal" strokeWidth="1.5" strokeLinecap="round"></path> 
                          <path d="M20 22V9.5" stroke="teal" strokeWidth="1.5" strokeLinecap="round"></path> 
                          <path d="M15 22V17C15 15.5858 15 14.8787 14.5607 14.4393C14.1213 14 13.4142 14 12 14C10.5858 14 9.87868 14 9.43934 14.4393C9 14.8787 9 15.5858 9 17V22" stroke="teal" strokeWidth="1.5"></path> 
                          </g>
                          </svg>
                        </Link>

                                 <svg fill="teal" className='w-2 h-2' version="1.1" id="XMLID_287_" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" xmlSpace="preserve">
                                ...
                                <Link href="/login/seeker" className='cursor-pointer text-teal-500'>
                                Login
                                </Link>
                                ...
                                <p className=' text-teal-500'>Seeker</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className='py-20 w-full flex  items-center justify-center'>
                <div className='w-sm mx-auto flex flex-col items-center gap-6 justify-between'>
