                  ...
                  <div className="flex justify-between items-center gap-2">
                    ...
                    <div className="flex flex-col justify-center items-start">
                      ...
                      <HoverCardComponent
                        ...
                        line2={req.geek instanceof Object ? req?.geek?.address?.city &&  "City: " + req?.geek?.address?.city : "" }
                        mutedLine={req.geek instanceof Object ? req?.geek?.address?.state &&  "State: " + req?.geek?.address?.state : "" }
                      />
